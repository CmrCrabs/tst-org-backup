...
- the file's modification time matches the extension's saved modification time for the file (on installation, manually update either tst , or local to resync)
