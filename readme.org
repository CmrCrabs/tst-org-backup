...
TODO workflow explainer "a sample workflow would be as follows..."
...
wherein plaintext org headings are converted to tst folders: `about:treestyletab-group?my-folder-name`
...
there is adecent chance that any tab title that contains square brackets or other similar chicanery will break the parsing... realistically if this happens you will notice it whne trying to import and can go into the org file and spot the issue (as it would also break org mode rendering).
